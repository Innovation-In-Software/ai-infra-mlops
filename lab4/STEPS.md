...
![Step 1 — `ls -1 lab4`](images/step-01-lab4-folder.png)
...
![Step 2 — artifact copy and `ls -1 ../workspace/lab4/models`](images/step-02-artifacts.png)
...
![Step 3 — `python3 -m pip install -r requirements.txt`](images/step-03-pip.png)
...
![Step 4 — `python3 scripts/setup_project_structure.py`](images/step-04-structure.png)
...
![Step 5 — `python3 -m pytest tests/unit -q`](images/step-05-unit-tests.png)
...
![Step 6 — `python3 scripts/run_compliance_checks.py`](images/step-06-compliance.png)
...
![Step 7 — `python3 scripts/setup_codepipeline.py`](images/step-07-pipeline.png)
...
![Step 9 — report generation and `cat ... | head -20`](images/step-09-report.png)
...
![Step 10 — `python3 scripts/validate_lab4.py`](images/step-10-validate.png)
