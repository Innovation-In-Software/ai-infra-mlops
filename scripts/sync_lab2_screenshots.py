#!/usr/bin/env python3
"""Copy canonical Lab 2 screenshots from instructor captures to lab2/images/."""
...
MANIFEST = REPO / "lab2" / "config" / "lab2_screenshot_manifest.json"
IMAGES = REPO / "lab2" / "images"
DEFAULT_SOURCE = Path(
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Sync Lab 2 screenshots to lab2/images/")
    ...
    if args.git_push:
        subprocess.run(
            [
                ...
                "add",
                "lab2/images/",
                "lab2/config/lab2_screenshot_manifest.json",
                "lab2/STEPS.md",
                "scripts/sync_lab2_screenshots.py",
            ],
            cwd=REPO,
            check=False,
        )
        subprocess.run(
            ["git", "commit", "-m", "Lab 2: sync participant screenshots and update STEPS."],
            cwd=REPO,
            check=False,
        )
