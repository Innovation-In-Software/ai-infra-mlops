#!/usr/bin/env python3
"""Copy canonical Lab 3b screenshots to optional/lab3b/images/."""
...
MANIFEST = REPO / "optional" / "lab3b" / "config" / "lab3b_screenshot_manifest.json"
IMAGES = REPO / "optional" / "lab3b" / "images"
DEFAULT_SOURCE = Path(
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Sync Lab 3b screenshots to optional/lab3b/images/")
    ...
    if args.git_push:
        subprocess.run(
            [
                "git",
                "add",
                "optional/lab3b/images/",
                "optional/lab3b/config/lab3b_screenshot_manifest.json",
                "optional/lab3b/STEPS.md",
                "scripts/sync_lab3b_screenshots.py",
            ],
            cwd=REPO,
            check=False,
        )
        subprocess.run(
            ["git", "commit", "-m", "Lab 3b: sync EC2 screenshots and embed in STEPS.md."],
            cwd=REPO,
            check=False,
        )
