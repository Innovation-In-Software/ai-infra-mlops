#!/usr/bin/env python3
"""Copy canonical Lab 4b screenshots to optional/lab4b/images/."""
...
MANIFEST = REPO / "optional" / "lab4b" / "config" / "lab4b_screenshot_manifest.json"
IMAGES = REPO / "optional" / "lab4b" / "images"
DEFAULT_SOURCE = Path(
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Sync Lab 4b screenshots to optional/lab4b/images/")
    ...
    if args.git_push:
        subprocess.run(
            [
                "git",
                "add",
                "optional/lab4b/images/",
                "optional/lab4b/config/lab4b_screenshot_manifest.json",
                "optional/lab4b/STEPS.md",
                "scripts/sync_lab4b_screenshots.py",
            ],
            cwd=REPO,
            check=False,
        )
        subprocess.run(
            ["git", "commit", "-m", "Lab 4b: sync EC2 screenshots and embed in STEPS.md."],
            cwd=REPO,
            check=False,
        )
